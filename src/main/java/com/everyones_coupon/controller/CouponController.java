...
public class CouponController {
    ...
    public ResponseEntity<Page<CouponResponse>> getCoupons(
        ...
        Page<CouponResponse> coupons = couponService.getCouponsByGame(gameId, pageable, clientIp);
    ...
    public ResponseEntity<List<CouponResponse>> getTopCoupons(
        ...
        String clientIp = getClientIp(request);
        List<CouponResponse> topCoupons = couponService.getTopCoupons(gameId, clientIp);
